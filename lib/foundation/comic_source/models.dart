...
class Comic {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (favoriteUpdate != null) {
      json["favoriteUpdate"] = favoriteUpdate!.toJson();
    }
    return json;
  }
  ...
  Comic.fromJson(Map<String, dynamic> json, this.sourceKey)
    : title = json["title"],
      ...
      favoriteUpdate = FavoriteUpdateHint.fromJson(json["favoriteUpdate"]);
  ...
  static FavoriteUpdateHint? fromJson(dynamic value) {
    ...
    if (rawMetadata is Map) {
      try {
        ...
        Log.warning("FavoriteUpdate", "Dropped non-serializable metadata: $e");
      }
    }
